...
def _data(
    ...
    *,
    ...
    return RepRapFirmwareData(
        ...
        estimated_remaining_filament=55.0,
        estimated_remaining_file=65.0,
        estimated_remaining_slicer=60.0,
        warm_up_duration=10.0,
        layer_time=20.0,
        last_layer_time=18.0,
        layer=3,
        total_layers=10,
        layers_remaining=7,
        file_size=1000,
        filament_used=250.0,
        total_filament=1000.0,
        filament_remaining=750.0,
        layer_filament_used=25.0,
